...
public class TestHelper {
    ...
    public static final Map<String, String> TEST_DATABASES = ImmutableMap.of(TEST_DATABASE_1, TEST_REAL_DATABASE1, TEST_DATABASE_2, TEST_REAL_DATABASE2);
    public static final String TEST_FIRST_DATABASE = TEST_DATABASES.get(TEST_DATABASE_1);
    ...
    public static Configuration.Builder defaultConnectorConfig() {
        return defaultMultiDatabaseConfig(Collections.singletonList(TEST_DATABASE_1));
    }
    ...
    public static Configuration.Builder defaultMultiPartitionConfig() {
        return defaultMultiPartitionConfig(TEST_DATABASE_1);
    }
