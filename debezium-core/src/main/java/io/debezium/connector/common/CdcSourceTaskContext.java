...
public class CdcSourceTaskContext {
    ...
    public LoggingContext.PreviousContext configureLoggingContext(String contextName, String partition) {
        return LoggingContext.forConnector(connectorType, connectorName, contextName, taskId, partition);
    }
